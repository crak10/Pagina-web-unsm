...
/**
 * Cargar WordPress
 * Integración de WordPress en la página de misión y visión
 */
...
<head>
    ...
    <meta name="description" content="Conoce la misión y visión institucional de la Universidad Nacional de San Martín - UNSM.">
    <meta name="keywords" content="UNSM, misión, visión, valores, universidad nacional de san martín">
    <meta name="author" content="Universidad Nacional de San Martín">
    <meta name="robots" content="index, follow">
    <meta name="theme-color" content="#359444">

    <title>Misión y Visión - UNSM</title>
...
<body>
    ...
    <main>
        <section class="mission-hero">
            <div class="mission-hero-content">
                <p class="mission-hero-eyebrow">Identidad Institucional</p>
                <h1>Misión y Visión</h1>
                <p>Inspiramos el desarrollo sostenible de la Amazonía peruana a través de la excelencia académica, la investigación y la responsabilidad social.</p>
            </div>
        </section>

        <section class="mission-vision-section">
            <div class="section-header">
                <span class="section-subtitle">Compromiso UNSM</span>
                <h2>Lo que nos guía</h2>
                <p>La misión y visión definen nuestro propósito y nos orientan hacia la formación de profesionales íntegros que transformen positivamente la región y el país.</p>
            </div>

            <div class="mission-vision-grid">
                <div class="mission-row">
                    <article class="mission-card is-active" id="missionCard">
                        <div class="mission-card-header">
                            <span class="mission-pill-label">NUESTRA MISIÓN</span>
                            <h3>Brindar formación profesional de excelencia</h3>
                        </div>
                        <p>
                            Brindar formación profesional a los estudiantes, con valores humanísticos y competencias científicas,
                            tecnológicas de innovación y emprendimiento; comprometidos con la mejora continua y responsabilidad social
                            en beneficio del desarrollo sostenible de la región y el país.
                        </p>
                    </article>
                    <div class="mission-row-badge">
                        <button class="mission-badge is-active" data-highlight-target="missionCard">
                            Nuestra Misión
                        </button>
                    </div>
                </div>
                ...
                <div class="mission-row">
                    <article class="mission-card" id="visionCard">
                        <div class="mission-card-header">
                            <span class="mission-pill-label">NUESTRA VISIÓN</span>
                            <h3>Ser la universidad líder en la Amazonía</h3>
                        </div>
                        <p>
                            Ser la universidad líder en la región amazónica, reconocida por su excelencia académica y su compromiso
                            con la formación de profesionales capaces de autogestionar su aprendizaje y generar soluciones innovadoras
                            y sostenibles.
                        </p>
                    </article>
                    <div class="mission-row-badge">
                        <button class="mission-badge" data-highlight-target="visionCard">
                            Nuestra Visión
                        </button>
                    </div>
                </div>
        ...
        <section class="mission-actions">
            <div class="mission-actions-grid">
                <a class="mission-action-card" href="../../contacto/indexContac.php">
                    <div class="mission-action-icon">
                        <img src="../../imagenes/logo correo.png" alt="Enviar mensaje" width="40" height="40">
                    </div>
                    <div>
                        <p>¿Deseas escribirnos?</p>
                        <strong>Enviar mensaje</strong>
                    </div>
                </a>
                <a class="mission-action-card" href="../../#libro-reclamaciones">
                    <div class="mission-action-icon">
                        <img src="../../imagenes/logo portal de trans.png" alt="Libro de reclamaciones" width="40" height="40">
                    </div>
                    <div>
                        <p>Tu voz es importante</p>
    ...
    <script src="js/sriptMision.js" defer></script>
    <div id="fb-root"></div>
