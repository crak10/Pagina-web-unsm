...
/**
 * Cargar WordPress
 * Integración de WordPress en la página de autoridades
 */
...
<head>
    ...
    <meta name="description" content="Autoridades Universitarias y Decanos de la Universidad Nacional de San Martín - UNSM">
    <meta name="keywords" content="UNSM, Autoridades, Decanos, Universidad San Martín">
    <meta name="author" content="Universidad Nacional de San Martín">
    <meta name="robots" content="index, follow">
    <meta name="theme-color" content="#359444">
    
    <title>Autoridades Universitarias - UNSM</title>
...
<body>
    ...
    <!-- Contenido Principal -->
    <main>
        <!-- Sección Autoridades Universitarias -->
        <section class="authorities-section">
            <div class="section-banner">
                <h2>AUTORIDADES UNIVERSITARIAS</h2>
            </div>
            <!-- Versión Desktop: Grid con rector en el centro -->
            <div class="authorities-container-wrapper">
                <div class="authorities-container" id="authoritiesCarousel">
                    <div class="authority-card authority-card-rector carousel-slide">
                        <div class="authority-image">
                            <img src="imagenes/rectorado/rector.jpg" alt="Dr. Ricardo Raul Layza Castañeda">
                        </div>
                        <div class="authority-info">
                            <h3>Dr. RICARDO RAUL LAYZA CASTAÑEDA</h3>
                            <p class="authority-title">Rector</p>
                            <button class="btn-resolucion">Resolución</button>
                        </div>
                    </div>
                    <div class="authority-card carousel-slide">
                        <div class="authority-image">
                            <img src="imagenes/rectorado/VICERRECTORA investigacion.jpg" alt="Dra. Dahpne Viena Oliveira">
                        </div>
                        <div class="authority-info">
                            <h3>Dra. DAHPNE VIENA OLIVEIRA</h3>
                            <p class="authority-title">Vicerrectora de Investigación</p>
                            <button class="btn-resolucion">Resolución</button>
                        </div>
                    </div>
                    <div class="authority-card carousel-slide">
                        <div class="authority-image">
                            <img src="imagenes/rectorado/VICERRECTOR academico.jpg" alt="Dr. Marco Armando Galvez Diaz">
                        </div>
                        <div class="authority-info">
                            <h3>Dr. MARCO ARMANDO GALVEZ DIAZ</h3>
                            <p class="authority-title">Vicerrector Académico</p>
                            <button class="btn-resolucion">Resolución</button>
                        </div>
                    </div>
                </div>
                ...
                <button class="authorities-carousel-prev" onclick="moveAuthoritySlide(-1)" aria-label="Autoridad anterior">
                    <span aria-hidden="true">‹</span>
                </button>
                <button class="authorities-carousel-next" onclick="moveAuthoritySlide(1)" aria-label="Siguiente autoridad">
                    <span aria-hidden="true">›</span>
                </button>
                
                <!-- Indicadores (solo móvil) -->
                <div class="authorities-carousel-indicators" id="authoritiesCarouselDots" role="tablist" aria-label="Indicadores de autoridades"></div>
            </div>
        </section>

        <!-- Sección Decanos -->
        <section class="deans-section">
            <div class="section-banner">
                <h2>DECANOS</h2>
            </div>
            <div class="deans-container">
                <div class="dean-card">
                    <div class="dean-image">
                        <img src="imagenes/decanos/decano ciencias agrarias.png" alt="Dr. Carlos Rengifo Saavedra">
                    </div>
                    <div class="dean-info">
                        <h3>Dr. CARLOS RENGIFO SAAVEDRA</h3>
                        <p class="dean-title">Decano Facultad de Ciencias Agrarias</p>
                    </div>
                </div>
                <div class="dean-card">
                    <div class="dean-image">
                        <img src="imagenes/decanos/decano agroindustrias.png" alt="Dr. Enrique Navarro Ramírez">
                    </div>
                    <div class="dean-info">
                        <h3>Dr. ENRIQUE NAVARRO RAMÍREZ</h3>
                        <p class="dean-title">Decano Facultad de Ingeniería Agroindustrial</p>
                    </div>
                </div>
                <div class="dean-card">
                    <div class="dean-image">
                        <img src="imagenes/decanos/decano ciencias economicas.png" alt="Dr. Anibal Pinchi Vásquez">
                    </div>
                    <div class="dean-info">
                        <h3>Dr. ANIBAL PINCHI VÁSQUEZ</h3>
                        <p class="dean-title">Decano Facultad de Ciencias Económicas</p>
                    </div>
                </div>
                <div class="dean-card">
                    <div class="dean-image">
                        <img src="imagenes/decanos/decana MH.png" alt="Dra. Alicia Bartra Reátegui">
                    </div>
                    <div class="dean-info">
                        <h3>Dra. ALICIA BARTRA REÁTEGUI</h3>
                        <p class="dean-title">Decana Facultad de Medicina Humana</p>
                    </div>
                </div>
                <div class="dean-card">
                    <div class="dean-image">
                        <img src="imagenes/decanos/decano fisi.png" alt="Dr. Juan Carlos García Castro">
                    </div>
                    <div class="dean-info">
                        <h3>Dr. JUAN CARLOS GARCÍA CASTRO</h3>
                        <p class="dean-title">Decano Facultad de Ingeniería de Sistemas e Informática</p>
                    </div>
                </div>
                <div class="dean-card">
                    <div class="dean-image">
                        <img src="imagenes/decanos/decana ciencias de la salud.jpg" alt="Dra. Evangelina Ampuero Fernández">
                    </div>
                    <div class="dean-info">
                        <h3>Dra. EVANGELINA AMPUERO FERNÁNDEZ</h3>
                        <p class="dean-title">Decana Facultad de Ciencias de la Salud</p>
                    </div>
                </div>
                <div class="dean-card">
                    <div class="dean-image">
                        <img src="imagenes/decanos/decano de educacion.png" alt="Dr. Luis Manuel Vargas Vásquez">
                    </div>
                    <div class="dean-info">
                        <h3>Dr. LUIS MANUEL VARGAS VÁSQUEZ</h3>
                        <p class="dean-title">Decano Facultad de Educación y Humanidades</p>
                    </div>
                </div>
                <div class="dean-card">
                    <div class="dean-image">
                        <img src="imagenes/decanos/decana de ecologia.jpg" alt="Dra. Astriht Ruiz Ríos">
                    </div>
                    <div class="dean-info">
                        <h3>Dra. ASTRIHT RUIZ RÍOS</h3>
                        <p class="dean-title">Decana Facultad de Ecología</p>
                    </div>
                </div>
                <div class="dean-card">
                    <div class="dean-image">
                        <img src="imagenes/decanos/decano de derecho.png" alt="Dr. José Absalón Quevedo Bustamante">
                    </div>
                    <div class="dean-info">
                        <h3>Dr. JOSÉ ABSALÓN QUEVEDO BUSTAMANTE</h3>
                        <p class="dean-title">Decano Facultad de Derecho y Ciencias Políticas</p>
                    </div>
                </div>
                <div class="dean-card">
                    <div class="dean-image">
                        <img src="imagenes/decanos/decano de fica.png" alt="Dr. Enrique Napoleón Martínez Quiroz">
                    </div>
                    <div class="dean-info">
                        <h3>Dr. ENRIQUE NAPOLEÓN MARTÍNEZ QUIROZ</h3>
                        <p class="dean-title">Decano Facultad de Ingeniería Civil y Arquitectura</p>
                    </div>
                </div>
                <div class="dean-card">
                    <div class="dean-image">
                        <img src="imagenes/decanos/decano MV.png" alt="Dr. Ricardo Castañeda Cabanillas">
                    </div>
                    <div class="dean-info">
                        <h3>Dr. RICARDO CASTAÑEDA CABANILLAS</h3>
                        <p class="dean-title">Decano Facultad de Medicina Veterinaria</p>
                    </div>
                </div>
            </div>
        </section>
    ...
    <script src="js/scriptAuto.js" defer></script>
    <div id="fb-root"></div>
